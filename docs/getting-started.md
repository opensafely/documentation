...
for OpenSAFELY's data. [Read about our pilot onboarding programme here](https://www.opensafely.org/onboarding-new-users/).  Once approved, your Github user account will be added to our `opensafely` Github organisation, along with your study repository, which gives you the ability to run your study against real data.  [Read more about permissions here](permissions.md).
