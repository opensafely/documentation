...
: In-hospital patient admissions in NHS Trusts in England.

**Available from**
: Data are available from early 2016.
...
: Admission and discharge dates; routes of admission; reason for admission; diagnoses; treatments; discharge destination.
