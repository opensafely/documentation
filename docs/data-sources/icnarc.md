...
: Adult ICU/HDUs admissions in England, Wales, NI.
...
: unclear, possibly non-intubated ventilation

**Basic respiratory support**
: unclear, possibly intubated ventilation

**Admission**
: these include _any_ admission to ICU even if the patient did not require critical care, for example due to bed pressures elsewhere in the hospital.
