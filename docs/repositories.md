...
Note that if someone else wants to commit to your recently created OpenSAFELY repo, they may need to wait up to 30 minutes for the necessary write permissions to be granted.
