...
7.  **Check the output for [disclosivity](releasing/output-checking.md)** within the server, and redact if necessary.
8.  **[Release](releasing/releasing-files.md) the outputs** via GitHub.
