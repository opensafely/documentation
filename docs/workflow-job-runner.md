Analysis scripts are submitted to the server via the Job Runner website at [https://jobs.opensafely.org](https://jobs.opensafely.org). 
...
See the [Project Pipelines section](project-pipelines.md) for more details. 