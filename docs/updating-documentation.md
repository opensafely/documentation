...
If you want to make changes to the  study definition variables [here](study-def-extractor-functions.md), edit the docstrings in the [`patients.py` file in the cohortextractor repository](https://github.com/opensafely/cohort-extractor/blob/master/cohortextractor/patients.py).
...
At least one commit in the pull request should be named using the prefix `fix: `. For example `fix: typo in age_as_of docstring`. 
