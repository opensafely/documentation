...
!!! note "The following information is for OpenSAFELY's internal output-checkers only"
    Researchers MUST NOT release their output files themselves - contact <disclosurecontrol@opensafely.org> to make a release request.
